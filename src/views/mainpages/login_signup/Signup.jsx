...
//   const [showPassword, setShowPassword] = useState(false);
//   const [showConfirmPassword, setShowConfirmPassword] = useState(false);
//   const [abroadReason, setAbroadReason] = useState(''); // For "Why you want to be a part of abroad"
//   const [document1, setDocument1] = useState(null); // For the first file upload
//   const [document2, setDocument2] = useState(null); // For the second file upload
//   const [businessDivision, setBusinessDivision] = useState(''); // For business division dropdown
...
//     try {
//       const request = await post('http://localhost:4000/auth/register', { 
//         name, email, password, organization, phoneNumber, state, city, abroadReason, document1, document2, businessDivision 
//       });
//       const response = request.data;
...
//             {/* New Fields */}
//             <div className="mb-4">
//               <label htmlFor="abroadReason" className="block text-gray-700 font-semibold">Why you want to be a part of abroad</label>
//               <input
//                 type="text"
//                 id="abroadReason"
//                 value={abroadReason}
...
//             <div className="mb-4">
//               <label htmlFor="document1" className="block text-gray-700 font-semibold">Document 1 (Document Verified?)</label>
//               <input
//                 type="file"
//                 id="document1"
...
//             <div className="mb-4">
//               <label htmlFor="document2" className="block text-gray-700 font-semibold">Document 2 (Document Verified?)</label>
//               <input
//                 type="file"
//                 id="document2"
...
//             <div className="mb-4">
//               <label htmlFor="businessDivision" className="block text-gray-700 font-semibold">Business Division</label>
//               <select
//                 id="businessDivision"
...
console.log('doc',document1)
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic validation
    if (!name || !email || !organization || !phoneNumber || !state || !city || !password || !confirmPassword) {
      toast({
    ...
    try {
      const response = await post('http://localhost:4000/auth/register', formData, {
...
{/* ... */}
            ...
            <div className="mb-4">
              <label htmlFor="abroadReason" className="block text-gray-700 font-semibold">Why do you want to be a part of abroad?</label>
              <input
                type="text"
                id="abroadReason"
                value={abroadReason}
